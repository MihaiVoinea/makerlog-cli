...
class Login extends _react.Component {
  ...
  async componentDidMount() {
    ...
    try {
      ...
      if (body.token) {
        _store.default.set("token", body.token);

        this.setState({
          message: "Logged in succesfully."
        });
      } else if (body.non_field_errors) this.setState({
...
},{"../config/store.config":"../config/store.config.js","../config/phin.config":"../config/phin.config.js","../components/loader":"../components/loader.js"}]},{},["login.js"], null)
